    ...
    <div>
      ...
      <div  class="container">
        ...
        <div  class="imagemContainer">
          <img  src="@/assets/insertionSort.png" alt="Selection Sort" width="500" height="500" />
      ...
      <input  v-show="!ordenou" @click="insertionSort" type="submit" class="btn btn-primary mr-2" data-toggle="button" value="Ordenar"/>
      ...
      methods: {
        ...
        for (var i = 1; i < length; i++) { 
          ...
          while (j>=0 && key<this.elementos[j]) { 
            ...
            //A posição é calculada subtraindo o índice do elemento j+1 pelo índice do elemento j, multiplicado por 100. 
            ...
            //tester trecho de if depois, para saber quando o elemento ira se estabelecer
